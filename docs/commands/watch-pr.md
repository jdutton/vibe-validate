...
- [validate command](../skills/vibe-validate/cli-reference.md#validate) - Run validation phases
- [history command](../skills/vibe-validate/cli-reference.md#history) - View validation timeline
