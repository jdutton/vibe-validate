...
- [Configuration Reference](./skills/setting-up-projects/configuration-reference.md) - Environment-specific commands
- [Local Development Guide](./contributing/local-development.md) - Testing changes locally
