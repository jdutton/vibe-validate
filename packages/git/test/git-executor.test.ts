...
describe('git-executor', () => {
  describe('validateGitRef', () => {
    ...
    describe('invalid refs - command injection prevention', () => {
  ...
  describe('validateNotesRef', () => {
    describe('valid notes refs', () => {
  ...
  describe('validateTreeHash', () => {
    describe('valid tree hashes', () => {
    ...
    describe('invalid tree hashes - command injection prevention', () => {
