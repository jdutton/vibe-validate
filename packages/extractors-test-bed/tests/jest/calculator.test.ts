/**
 * Jest tests with INTENTIONAL FAILURES for testing error extractors
 *
 * This test suite is EXPECTED to fail. Each test demonstrates a different
 * failure pattern that error extractors must handle.
 */
